...
function DialogueBubble({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      padding: '14px 18px',
      maxWidth: 500,
      boxShadow: highlighted ? '0 0 0 3px rgba(245,158,11,.4), 0 4px 12px rgba(0,0,0,.08)' : 'var(--shadow-card)',
  ...
  }, ar), showTranslation && id && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      marginTop: 6,
  ...
  }, id)), /*#__PURE__*/React.createElement(AudioButton, {
    playing: playing,
    onClick: onPlay,
    size: "sm",
