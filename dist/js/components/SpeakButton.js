...
function SpeakButton({
  ...
  const cfg = {
    ...
    wrong: {
      ...
      color: '#fff',
      icon: 'x-circle',
      title: heard ? `Terdengar: ${heard}` : 'Tidak terdengar'
    }
  }[phase];
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, phase === 'idle' || phase === 'listening' ? /*#__PURE__*/React.createElement("svg", {
    width: iconSize,
    height: iconSize,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    size: iconSize,
    color: cfg.color
  })), (phase === 'correct' || phase === 'wrong') && /*#__PURE__*/React.createElement("div", {
    className: "anim-in",
    style: {
      position: 'absolute',
      top: dim + 4,
