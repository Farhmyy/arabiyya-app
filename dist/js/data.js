...
const DATA = {
  ...
  chapter3: {
    ...
    objectives: ['Memahami fungsi sosial, struktur teks, dan unsur kebahasaan (bunyi, kata, dan makna) dari teks sederhana yang berkaitan dengan tema عِيَادَةُ الْمَرِيضِ yang melibatkan tindak tutur mendoakan orang sakit dengan memperhatikan susunan gramatikal الْفِعْلُ الْمَاضِي وَالْجُمْلَةُ الْفِعْلِيَّة', 'Menganalisis gagasan dari teks sederhana yang berkaitan dengan tema عِيَادَةُ الْمَرِيضِ dengan memperhatikan bentuk, makna, dan fungsi dari susunan gramatikal الْفِعْلُ الْمَاضِي وَالْجُمْلَةُ الْفِعْلِيَّة', 'Mendemonstrasikan tindak tutur mendoakan orang sakit dengan memperhatikan bentuk, makna, dan fungsi dari susunan gramatikal الْفِعْلُ الْمَاضِي وَالْجُمْلَةُ الْفِعْلِيَّة baik secara lisan maupun tulisan', 'Menyajikan hasil analisis gagasan dari teks sederhana yang berkaitan dengan tema عِيَادَةُ الْمَرِيضِ dengan memperhatikan bentuk, makna, dan fungsi dari susunan gramatikal الْفِعْلُ الْمَاضِي وَالْجُمْلَةُ الْفِعْلِيَّة']
  },
  hiwar: {
    scenes: [{
      id: 'scene-salam',
