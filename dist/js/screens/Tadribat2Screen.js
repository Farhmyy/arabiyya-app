...
function useTadribat2Content() {
  ...
  const transform = raw => {
    ...
    const compatible = cloudQs.length === local.length && local.every((lq, i) => cloudQs[i]?.prompt === lq.prompt);
...
function Tadribat2Screen({
  ...
  const [savedSession] = useState(() => {
    try {
      return JSON.parse(sessionStorage.getItem(T2_KEY)) || {};
    } catch {
      return {};
    }
  });
  ...
  useEffect(() => {
    ...
    try {
      sessionStorage.setItem(T2_KEY, JSON.stringify({
        currentIdx,
        tempSelected,
        answeredMap,
        timeLeft
  ...
  if (!started) {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u0627\u0644\u062A\u064E\u0651\u062F\u0652\u0631\u0650\u064A\u0628\u064E\u0627\u062A\u064F \u0662 \xB7 Latihan 2"), /*#__PURE__*/React.createElement("h1", {
      style: {
        fontSize: 26,
        fontWeight: 700,
        margin: '10px 0 8px'
      }
    }, "Latihan Qawaid"), /*#__PURE__*/React.createElement("p", {
      lang: "ar",
      style: {
    ...
    }, "\u0627\u0644\u0652\u0642\u064E\u0648\u064E\u0627\u0639\u0650\u062F\u064F"), /*#__PURE__*/React.createElement("p", {
      style: {
        color: 'var(--color-text-secondary)',
        fontSize: 15,
        lineHeight: 1.7,
    ...
    }, "Uji pemahaman tata bahasa: fi'il m\u0101dh\u012B, mudh\u0101ri', dan jumlah fi'liyyah.", /*#__PURE__*/React.createElement("br", null), "Kamu bisa ", /*#__PURE__*/React.createElement("strong", null, "melompat antar soal"), " sesuai keinginan."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
      ...
      label: 'XP per Soal',
      value: `+${tadribat2.xp_per_correct} XP`,
      icon: 'star'
    }, {
      label: 'Waktu',
      value: `${Math.round(T2_DURATION / 60)} menit`,
      icon: 'clock'
    ...
    }, "\u23F1\uFE0F Waktu berjalan otomatis. Bisa dicoba berkali-kali."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 12,
        justifyContent: 'center',
  ...
  if (showResults) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      name: perfectScore ? 'trophy' : 'award',
      size: 40
    })), /*#__PURE__*/React.createElement(Badge, {
      ...
      }, m.label.slice(0, 4)), /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 13,
          fontWeight: 600
        }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Tadribat 2 \xB7 Latihan Qawaid"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'var(--color-text-light)',
      marginTop: 2
    }
  }, "Fi'il m\u0101dh\u012B, mudh\u0101ri', & jumlah fi'liyyah")), /*#__PURE__*/React.createElement(TimerChip, null)), /*#__PURE__*/React.createElement(StepProgress, {
  ...
  }, q.prompt), q.type === 'order' && q.tokens && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--color-accent-50)',
      borderRadius: 14,
      padding: '14px 16px',
  ...
  }, "Kata-kata yang harus disusun:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      flexWrap: 'wrap',
  ...
  }, q.tokens.map((token, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      padding: '8px 14px',
      borderRadius: 999,
  ...
  }, token)))), q.arabic_display && q.type !== 'order' && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--color-accent-50)',
      borderRadius: 16,
      padding: 24,
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      disabled: revealed,
      style: {
        padding: isOrder ? '14px 16px' : '16px 18px',
        borderRadius: 14,
        ...
        fontSize: isOrder ? 16 : isAr ? 22 : 15,
        fontWeight: 600,
        ...
        direction: isAr ? 'rtl' : 'ltr',
        wordBreak: isOrder ? 'keep-all' : 'normal'
      }
  ...
  }, "+", tadribat2.xp_per_correct, " XP")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
      justifyContent: 'flex-end'
