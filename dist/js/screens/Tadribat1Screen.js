...
function Tadribat1Screen({
  ...
  if (!started) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        height: 80,
        borderRadius: 999,
        background: 'linear-gradient(135deg, var(--color-primary-bg) 0%, var(--color-secondary) 100%)',
        color: '#fff',
        margin: '0 auto 20px',
        display: 'flex',
        alignItems: 'center',
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      border: 'none',
      cursor: 'pointer',
      background: playing ? 'var(--color-primary-bg)' : 'linear-gradient(135deg, var(--color-primary-bg), var(--color-secondary))',
      color: '#fff',
      display: 'inline-flex',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    style: {
      ...
      background: contohPlaying ? 'var(--color-primary-bg)' : 'transparent',
